...
if(isset($_SESSION['user'])!="")
{
	...
	echo '
			...
			<meta http-equiv="refresh" content="3;url=Adminsignin.html">
			</head>
			<body >
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="Adminsignin.html"><span class="glyphicon glyphicon-home"></span> Home</a>
			</div>
						...
						<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
						  ...
						  <li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
							  <li><a tabindex="-1" href="Adminsignin.html">Manager Sign in</a></li>
	...
	<div class="container" id="homepage">
		<h1>Opps!</h1>
		<p>Wrong username or wrong password.</p>
	</div>
